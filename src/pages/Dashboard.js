              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                {canAdd && (
                  ...
                  >
                    ...
                    {activeProperties.length === 0 ? 'Google-Konto verbinden' : '+ Weiteres Konto verbinden'}
                  </BtnConnect>
                )}
                {!canAdd && (
                  <BtnConnect onClick={() => setShowUpgradeModal(true)} disabled={upgrading} style={{ fontSize: '0.875rem', padding: '0.625rem 1.125rem' }}>
