...
const i18n = {
  en: {
    ...
    plans: [
      { name: 'Basic',  price: '19', priceAnnual: '16', period: '/mo', features: ['1 domain', 'Full monthly PDF report', 'GSC data + AI analysis', 'Market radar + priorities', 'Email delivery'] },
      { name: 'Pro',    price: '39', priceAnnual: '32', period: '/mo', featured: true, features: ['3 domains', 'Everything in Basic', 'GA4 data (sessions, users)', 'White-label + client email', 'Custom logo & brand colors'] },
      { name: 'Agency', price: '79', priceAnnual: '66', period: '/mo', features: ['15 domains', 'Everything in Pro', 'GEO-Readiness Score', 'Bulk client reporting', 'Priority support'] },
    ],
    faqs: [
      ...
      { q: 'Can I use my own logo?', a: 'Yes, on Pro and Agency plans. Upload your logo and brand colors – your clients receive fully white-labeled reports with no RankBrief branding.' },
  ...
  de: {
    ...
    plans: [
      { name: 'Basic',  price: '19', priceAnnual: '16', period: '/Monat', features: ['1 Domain', 'Vollständiger PDF-Report', 'GSC-Daten + KI-Analyse', 'Markt-Radar + Top Prioritäten', 'Email-Versand'] },
      { name: 'Pro',    price: '39', priceAnnual: '32', period: '/Monat', featured: true, features: ['3 Domains', 'Alles in Basic', 'GA4-Daten (Sessions, Nutzer)', 'White-Label + Kunden-Email', 'Eigenes Logo & Brandfarben'] },
      { name: 'Agency', price: '79', priceAnnual: '66', period: '/Monat', features: ['15 Domains', 'Alles in Pro', 'GEO-Readiness Score', 'Kunden-Reporting', 'Priority Support'] },
    ],
    faqs: [
      ...
      { q: 'Kann ich mein eigenes Logo verwenden?', a: 'Ja, ab dem Pro-Plan. Logo und Brandfarben hochladen – deine Kunden erhalten vollständige White-Label Reports ohne RankBrief-Branding.' },
