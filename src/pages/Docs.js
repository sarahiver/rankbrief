    ...
    guides: {
      ...
      connect: {
        ...
        steps: [
          ...
          { title: 'Choose a plan', text: 'Your first month is completely free. Basic (1 domain, full report), Pro (3 domains + GA4 + white-label), or Agency (15 domains + GEO-Readiness).' },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Yes – depending on your plan: Basic tracks 1 domain, Pro tracks up to 3, Agency up to 15. Each domain gets its own monthly report.',
        },
        {
    ...
    guides: {
      ...
      connect: {
        ...
        steps: [
          ...
          { title: 'Plan wählen', text: 'Der erste Monat ist komplett kostenlos. Basic (1 Domain, vollständiger Report), Pro (3 Domains + GA4 + White-Label), Agency (15 Domains + GEO-Readiness).' },
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Ja – je nach Plan: Basic trackt 1 Domain, Pro bis zu 3, Agency bis zu 15. Jede Domain erhält ihren eigenen monatlichen Report.',
        },
        {
