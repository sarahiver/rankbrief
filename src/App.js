...
const noNavRoutes = ['/login', '/register', '/dashboard', '/onboarding', '/docs', '/settings', '/forgot-password', '/reset-password'];
const noFooterRoutes = ['/login', '/register', '/dashboard', '/onboarding', '/docs', '/settings', '/forgot-password', '/reset-password'];
